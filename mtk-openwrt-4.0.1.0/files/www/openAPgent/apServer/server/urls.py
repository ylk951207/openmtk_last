...
custom_router.register(r'v1/infos/systems/interfaces', views.HardwareInterfaceInfoViewSet, base_name='hardware_interface_info')
custom_router.register(r'v1/infos/systems/wireless', views.HardwareWirelessInfoViewSet, base_name='hardware_wireless_info')
